...
class Setting(object):
    def __init__(self, key, name=None, prefix=default_settings.SETTINGS_PREFIX,
                 processors=None):
...
class WritablePathSetting(WritablePathMixin, Setting):
    pass


class ExecutablePathSetting(ExecutablePathMixin, Setting):
    pass


class FormattedSetting(StringFormattingMixin, Setting):
    pass
...
class FormattedWritablePathSetting(StringFormattingMixin, WritablePathSetting):
    pass
